...
con_string = "mongodb+srv://Ramya:ramya1016@cluster0.voxyuak.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('sampleDB')

user_collection = pymongo.collection.Collection(db, 'demoDB')
...
def project_api_routes(endpoints):
    ...
    def read_users():
        ...
        try:
            ...
            output = [{'id' : user['id'], 'author' : user['author']} for user in users]
            resp['data'] = output
        except Exception as e:
            print(e)
            status = {
    ...
    def update_users():
        ...
        try:
            ...
            user_collection.update_one({"id":req_body['id']}, {"$set": req_body['update']})
